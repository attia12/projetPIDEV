...
class MedicamentController extends AbstractController
{
    ...
    public function index(MedicamentRepository $medicamentRepository,Request $request,ManagerRegistry $doctrine): Response
    {
        ...
        return $this->render('medicament/index.html.twig',array('medicaments' => $medicamentRepository->findAll(), "form"=>$form->createView()) );
